...
function leftComponent(){
    return <div className="leftComponent">
        <a rel="noreferrer" href="https://github.com/kylelainez/" target="_blank">
        ...
        <a rel="noreferrer" href="mailto:kyleadrianlainez@gmail.com" target="_blank" className="rotated">
            <div>
                kyleadrianlainez@gmail.com
            </div>
        </a>
        <a rel="noreferrer" href="https://www.linkedin.com/in/kyle-adrian-lainez/" target="_blank">
